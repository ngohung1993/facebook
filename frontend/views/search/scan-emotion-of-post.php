...
$this->registerJsFile(
    '@web/js/scan-emotion-of-post.js'
);

$this->title = 'Quét UID cảm xúc';
    ...
    <div class="panel panel-success">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <button type="submit" onclick="scan_emotion_of_post()" class="btn btn-primary">
                            Xác nhận
                        </button>
                    </div>
                </div>
