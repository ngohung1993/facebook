...
class BaseController extends Controller
{
    ...
    public function init()
    {
        ...
        if (!Yii::$app->user->isGuest) {
            ...
            $this->group = Group::find()->where(['user_id' => $this->user->id])->all();

            $this->facebook_accounts = ConnectHelper::get_access_token_by_username($this->user->username);
        }
    }
